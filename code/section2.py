...
def main():
    ...
    plt.title(r"Evolution of $J^{\mu}_{" + str(N) + "}$ over " + str(NB_INITIAL_STATES) + " simulations")
    plt.savefig("figures/expected_return_" + str(NB_INITIAL_STATES) + "_states_over_" + str(N) + "_steps.png")
